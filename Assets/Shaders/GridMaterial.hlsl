...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = dot(((MaterialFloat3)0.25000000),MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat Local2 = (Local1 + -0.40000001);
	MaterialFloat Local3 = (Local2 * -5.00000000);
	MaterialFloat Local4 = saturate(Local3);
	MaterialFloat Local5 = dot(((MaterialFloat3)0.00000000),MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat Local6 = (Local1 + Local5);
	MaterialFloat Local7 = (Local5 / Local6);
	MaterialFloat Local8 = (Local7 - 0.50000000);
	MaterialFloat Local9 = (Local8 * 4.00000000);
	MaterialFloat Local10 = (Local9 + 0.50000000);
	MaterialFloat Local11 = saturate(Local10);
	MaterialFloat Local12 = (DERIV_BASE_VALUE(Local4) * DERIV_BASE_VALUE(Local11));
	MaterialFloat Local13 = (Local5 * 12.50000000);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = 0.25000000.rrr;
