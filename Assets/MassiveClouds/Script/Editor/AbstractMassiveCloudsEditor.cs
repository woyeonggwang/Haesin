        ...
        protected void ProfileGUI(SerializedProperty parameter)
        {
            ...
            Section("Height Fog Parameters", () =>
            {
                ...
                if (heightFog)
                {
                    ...
                    EditorGUILayout.PropertyField(parameter.FindPropertyRelative("FarHeightFogRange"));
                    EditorGUILayout.PropertyField(parameter.FindPropertyRelative("HeightFogDensity"));
                }
            });
